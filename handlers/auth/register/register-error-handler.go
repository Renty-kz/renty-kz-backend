...
/* Organization Registration Error Handler */
func ErrOrganizationRegisterHandler(resultRegister *models.EntityOrganizations, ctx *gin.Context, errRegister string) {
	switch errRegister {
...
/* Moderator Registration Error Handler */
func ErrModeratorRegisterHandler(resultRegister *models.EntityModerators, ctx *gin.Context, errRegister string) {
	switch errRegister {
